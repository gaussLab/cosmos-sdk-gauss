...
func (suite *SimTestSuite) TestSimulateMsgWithdrawDelegatorReward() {
	...
	delegation := stakingtypes.NewDelegation(delegator.Address, validator0.GetOperator(), sdk.AccAddress(validator0), issuedShares)
...
func (suite *SimTestSuite) getTestingValidator0(accounts []simtypes.Account) stakingtypes.Validator {
	...
	return suite.getTestingValidator(accounts, commission0, commissionReallocation0, 0)
}

func (suite *SimTestSuite) getTestingValidator(accounts []simtypes.Account, commission stakingtypes.Commission, 
	commissionReallocation stakingtypes.CommissionReallocation, n int) stakingtypes.Validator {
