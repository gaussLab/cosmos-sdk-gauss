...
type ValidatorHistoricalRewards struct {
	...
	CumulativeReallocatedCommissionRatio github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=cumulative_reallocated_commission_ratio,json=cumulativeReallocatedCommissionRatio,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"cumulative_reallocated_commission_ratio" yaml:"cumulative_reallocated_commission_ratio"`
	ReferenceCount                       uint32                                      `protobuf:"varint,3,opt,name=reference_count,json=referenceCount,proto3" json:"reference_count,omitempty" yaml:"reference_count"`
}
...
func (m *ValidatorHistoricalRewards) GetCumulativeReallocatedCommissionRatio() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.CumulativeReallocatedCommissionRatio
	}
	return nil
}
...
type ValidatorCurrentRewards struct {
	...
	ReallocatedCommission github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=reallocated_commission,json=reallocatedCommission,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"reallocated_commission"`
...
func (m *ValidatorCurrentRewards) GetReallocatedCommission() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.ReallocatedCommission
	}
	return nil
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *ValidatorHistoricalRewards) Equal(that interface{}) bool {
	...
	if len(this.CumulativeReallocatedCommissionRatio) != len(that1.CumulativeReallocatedCommissionRatio) {
		return false
	}
	for i := range this.CumulativeReallocatedCommissionRatio {
		if !this.CumulativeReallocatedCommissionRatio[i].Equal(&that1.CumulativeReallocatedCommissionRatio[i]) {
			return false
		}
	}
...
func (this *ValidatorCurrentRewards) Equal(that interface{}) bool {
	...
	if len(this.ReallocatedCommission) != len(that1.ReallocatedCommission) {
		return false
	}
	for i := range this.ReallocatedCommission {
		if !this.ReallocatedCommission[i].Equal(&that1.ReallocatedCommission[i]) {
			return false
		}
	}
...
func (m *ValidatorHistoricalRewards) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CumulativeReallocatedCommissionRatio) > 0 {
		for iNdEx := len(m.CumulativeReallocatedCommissionRatio) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CumulativeReallocatedCommissionRatio[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ValidatorCurrentRewards) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ReallocatedCommission) > 0 {
		for iNdEx := len(m.ReallocatedCommission) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ReallocatedCommission[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ValidatorHistoricalRewards) Size() (n int) {
	...
	if len(m.CumulativeReallocatedCommissionRatio) > 0 {
		for _, e := range m.CumulativeReallocatedCommissionRatio {
			l = e.Size()
			n += 1 + l + sovDistribution(uint64(l))
		}
	}
...
func (m *ValidatorCurrentRewards) Size() (n int) {
	...
	if len(m.ReallocatedCommission) > 0 {
		for _, e := range m.ReallocatedCommission {
			l = e.Size()
			n += 1 + l + sovDistribution(uint64(l))
		}
	}
...
func (m *ValidatorHistoricalRewards) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CumulativeReallocatedCommissionRatio", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CumulativeReallocatedCommissionRatio = append(m.CumulativeReallocatedCommissionRatio, types.DecCoin{})
			if err := m.CumulativeReallocatedCommissionRatio[len(m.CumulativeReallocatedCommissionRatio)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *ValidatorCurrentRewards) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReallocatedCommission", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReallocatedCommission = append(m.ReallocatedCommission, types.DecCoin{})
			if err := m.ReallocatedCommission[len(m.ReallocatedCommission)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
