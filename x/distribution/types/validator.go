...
func NewValidatorHistoricalRewards(cumulativeRewardRatio sdk.DecCoins, 
	cumulativeReallocatedCommissionRatio sdk.DecCoins, referenceCount uint32) ValidatorHistoricalRewards {
	return ValidatorHistoricalRewards{
		CumulativeRewardRatio: cumulativeRewardRatio,
		CumulativeReallocatedCommissionRatio: cumulativeReallocatedCommissionRatio,
		ReferenceCount:        referenceCount,
	}
}

// create a new ValidatorCurrentRewards
func NewValidatorCurrentRewards(rewards sdk.DecCoins, reallocatedCommission sdk.DecCoins, period uint64) ValidatorCurrentRewards {
	return ValidatorCurrentRewards{
		Rewards: rewards,
		ReallocatedCommission: reallocatedCommission,
		Period:  period,
	}
}
