...
const (
	...
	FlagCommissionReserveRate     = "commission-reserve-rate"
	FlagCommissionReallocatedRate = "commission-reallocated-rate"

	FlagRecommander  = "recommander"
...
func init() {
	...
	fsDelegation.String(FlagRecommander, "", "The Bech22 address of the recommander to delegator")
...
// FlagSetCommissionReallocation Returns the FlagSet used for commission reallocation.
func FlagSetCommissionReallocation() *flag.FlagSet {
	fs := flag.NewFlagSet("", flag.ContinueOnError)

	fs.String(FlagCommissionReserveRate, "", "The node's reserved commission rate percentage")
	fs.String(FlagCommissionReallocatedRate, "", "The recommander's commission rate percentage")
...
func FlagSetRecommander() *flag.FlagSet {
	fs := flag.NewFlagSet("", flag.ContinueOnError)
	fs.String(FlagRecommander, "", "The recommander to the delegator")
	return fs
}
...
func flagSetCommissionReallocationUpdate() *flag.FlagSet {
	fs := flag.NewFlagSet("", flag.ContinueOnError)

	fs.String(FlagCommissionReserveRate, "", "The new commission reserve rate percentage")
