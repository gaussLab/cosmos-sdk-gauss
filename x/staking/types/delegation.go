...
//nolint:interfacer
func NewDelegation(delegatorAddr sdk.AccAddress, validatorAddr sdk.ValAddress, recommanderAddr sdk.AccAddress, shares sdk.Dec) Delegation {
	return Delegation{
...
func (d Delegation) GetRecommanderAddr() sdk.AccAddress {
	recAddr, err := sdk.AccAddressFromBech32(d.RecommanderAddress)
	if err != nil {
		panic(err)
	}
	return recAddr
...
func NewDelegationResp(
	delegatorAddr sdk.AccAddress, validatorAddr sdk.ValAddress, recommander sdk.AccAddress, shares sdk.Dec, balance sdk.Coin,
) DelegationResponse {
	return DelegationResponse{
		Delegation: NewDelegation(delegatorAddr, validatorAddr, recommander, shares),
		Balance:    balance,
	}
}
