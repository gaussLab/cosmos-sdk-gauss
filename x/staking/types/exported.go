...
type DelegationI interface {
	...
	GetRecommanderAddr() sdk.AccAddress // recommander sdk.AccAddress for the rewards
...
type ValidatorI interface {
	...
	GetCommissionReallocation() (sdk.Dec, sdk.Dec)		// validator commission reallocated rate
