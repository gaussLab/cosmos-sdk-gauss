...
func NewMsgCreateValidator(
	...
	commissionReallocation CommissionReallocation,  minSelfDelegation sdk.Int,
	...
	return &MsgCreateValidator{
		...
		CommissionReallocation: commissionReallocation,
	}, nil
}
...
func (msg MsgCreateValidator) ValidateBasic() error {
	...
	if msg.CommissionReallocation == (CommissionReallocation{}) {
		return sdkerrors.Wrap(sdkerrors.ErrInvalidRequest, "empty reallocated commission")
	}

	if err := msg.CommissionReallocation.Validate(); err != nil {
		return err
	}
...
func NewMsgEditValidator(valAddr sdk.ValAddress, description Description, newRate *sdk.Dec, 
	newCommissionReserveRate *sdk.Dec, newMinSelfDelegation *sdk.Int) *MsgEditValidator {
	return &MsgEditValidator{
		Description:       description,
		CommissionRate:    newRate,
		ValidatorAddress:  valAddr.String(),
		CommissionReserveRate: newCommissionReserveRate,
...
func (msg MsgEditValidator) ValidateBasic() error {
	...
	if msg.CommissionReserveRate != nil {
		if msg.CommissionReserveRate.GT(sdk.OneDec()) || msg.CommissionReserveRate.IsNegative() {
			return sdkerrors.Wrap(sdkerrors.ErrInvalidRequest, "commission reserve rate must be between 0 and 1 (inclusive)")
		}
	}
...
//nolint:interfacer
func NewMsgDelegate(delAddr sdk.AccAddress, valAddr sdk.ValAddress, recommanderAddr sdk.AccAddress, amount sdk.Coin) *MsgDelegate {
	return &MsgDelegate{
		DelegatorAddress: delAddr.String(),
		ValidatorAddress: valAddr.String(),
		RecommanderAddress: recommanderAddr.String(),
		Amount:           amount,
	}
}
