...
type MsgCreateValidator struct {
	...
	CommissionReallocation CommissionReallocation                 `protobuf:"bytes,8,opt,name=commission_reallocation,json=commissionReallocation,proto3" json:"commission_reallocation"`
}
...
type MsgEditValidator struct {
	...
	CommissionReserveRate *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=commission_reserve_rate,json=commissionReserveRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"commission_reserve_rate,omitempty" yaml:"commission_reserve_rate"`
	MinSelfDelegation     *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,5,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"min_self_delegation,omitempty" yaml:"min_self_delegation"`
}
...
var fileDescriptor_0926ef28816b35ab = []byte{
	...
	,
}
...
func (m *MsgEditValidator) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CommissionReserveRate != nil {
		{
			size := m.CommissionReserveRate.Size()
			i -= size
			if _, err := m.CommissionReserveRate.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintTx(dAtA, i, uint64(size))
		}
...
func (m *MsgEditValidator) Size() (n int) {
	...
	if m.CommissionReserveRate != nil {
		l = m.CommissionReserveRate.Size()
		n += 1 + l + sovTx(uint64(l))
	}
	if m.MinSelfDelegation != nil {
		l = m.MinSelfDelegation.Size()
...
func (m *MsgEditValidator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommissionReserveRate", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v github_com_cosmos_cosmos_sdk_types.Dec
			m.CommissionReserveRate = &v
			if err := m.CommissionReserveRate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
