...
var (
	...
	ErrEmptyRecommanderAddr            = sdkerrors.Register(ModuleName, 48, "empty recommander address")
	ErrInvalidRecommanderAddr          = sdkerrors.Register(ModuleName, 49, "invalid recommander address")
	ErrCommissionReallocationNegative  = sdkerrors.Register(ModuleName, 50, "commission-reallocation must be positive")
	ErrCommissionReallocationHuge      = sdkerrors.Register(ModuleName, 51, "commission-reallocation cannot be more than 100%")
	ErrCommissionReallocationUpdateTime = sdkerrors.Register(ModuleName, 52, "commission-reallocation cannot be changed more than once in 24h")
)
