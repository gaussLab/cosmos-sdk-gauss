...
func NewValidator(operator sdk.ValAddress, pubKey cryptotypes.PubKey, description Description) (Validator, error) {
	...
	return Validator{
		...
		CommissionReallocation: NewCommissionReallocation(sdk.ZeroDec(), sdk.ZeroDec()),
...
// SetInitialCommissionReallocation attempts to set a validator's initial commission. An
// error is returned if the commission is invalid.
func (v Validator) SetInitialCommissionReallocation(commissionReallocation CommissionReallocation) (Validator, error) {
	if err := commissionReallocation.Validate(); err != nil {
		return v, err
	}

	v.CommissionReallocation = commissionReallocation
...
func (v Validator) GetCommissionReallocation() (sdk.Dec, sdk.Dec)        { return v.CommissionReallocation.ReserveRate, v.CommissionReallocation.ReallocatedRate }
