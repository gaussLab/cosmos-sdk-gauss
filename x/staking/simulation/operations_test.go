...
func TestSimulateMsgUndelegate(t *testing.T) {
	...
	delegation := types.NewDelegation(delegator.Address, validator0.GetOperator(), sdk.AccAddress(validator0.Address), issuedShares)
...
func TestSimulateMsgBeginRedelegate(t *testing.T) {
	...
	delegation := types.NewDelegation(delegator.Address, validator1.GetOperator(), sdk.AccAddress(validator1.Address), issuedShares)
	app.StakingKeeper.SetDelegation(ctx, delegation)
...
func getTestingValidator0(t *testing.T, app *simapp.SimApp, ctx sdk.Context, accounts []simtypes.Account) types.Validator {
	...
	commissionReallocation0 := types.NewCommissionReallocation(sdk.ZeroDec(), sdk.OneDec())
	return getTestingValidator(t, app, ctx, accounts, commission0, commissionReallocatiion0, 0)
}
...
func getTestingValidator1(t *testing.T, app *simapp.SimApp, ctx sdk.Context, accounts []simtypes.Account) types.Validator {
	...
	commissionReallocation1 := types.NewCommissionReallocation(sdk.ZeroDec(), sdk.OneDec())
	return getTestingValidator(t, app, ctx, accounts, commission1, commissionReallocation1, 1)
}

func getTestingValidator(t *testing.T, app *simapp.SimApp, ctx sdk.Context, accounts []simtypes.Account, commission types.Commission, 
	commissionReallocation types.CommissionReallocation, n int) types.Validator {
